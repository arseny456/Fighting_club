...
text_field = Text(root, width=35, height=10, font="Times")
text_field.place(relx=0.15, rely=0.2)
...
me = Fighter('player1', text_log=text_field)
comp = Fighter("player2", text_log=text_field)
